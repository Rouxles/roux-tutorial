...
\centerline{\begin{tabular}{|p{0.91\textwidth}|}
	\hline
	\textbf{DR in FB slot flipped - Example 1 }\\ 
	\hline
	...
	\end{minipage}\\
	\hline
	Here we see a good DR, but instead of preserving its EO, we deliberately store it in the FB slot and and flip it. As long as we see an easy bottom insertion, flipped in slot is very much a sweet spot for DR. \\
	\hline
\end{tabular}}
